...
export class TenantEntity {
  ...
  @Column({ name: 'deploy_type', type: 'smallint', default: 1 })
  deployType!: number;

  @Column({ name: 'is_physical_isolate', type: 'boolean', default: false })
  isPhysicalIsolate!: boolean;

  @Column({ name: 'account_mode', type: 'smallint', default: 1 })
  accountMode!: number;

  @Column({ name: 'is_allow_multi_switch', type: 'boolean', default: true })
  ...
  @Column({ name: 'team_plan', type: 'smallint', default: 1 })
  teamPlan!: number;
...
export class TenantMemberEntity {
  ...
  @Column({ name: 'user_source', type: 'smallint', default: 1 })
  userSource!: number;
  ...
  @Column({ name: 'tenant_role', type: 'smallint', default: 3 })
  tenantRole!: number;
...
export class TenantRoleEntity {
  ...
  @Column({ name: 'system_role', type: 'smallint', nullable: true })
