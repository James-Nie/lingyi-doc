...
import type { BaseCellRenderer, CellRenderer, DirtyTracker, FreeTable, GroupedLayoutResult, LayerManager, RecordTreeColumnMeta, ViewportManager } from '@lingyi-doc/core-sheet';
import type { CellData, CellRange, ColumnDef, GroupRule, RecordRow } from '@lingyi-doc/core-types';
import type { CellCoord } from '@lingyi-doc/core-types';
...
export interface SheetRenderPassContext {
  ...
  /** 进度字段悬停单元格（用于显示滑块） */
  hoverProgressCell?: CellCoord | null;
  /** 进度条拖拽中的单元格 */
  progressDragCell?: CellCoord | null;
}
