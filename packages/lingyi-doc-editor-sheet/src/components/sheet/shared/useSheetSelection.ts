...
import { applyAutofill, normalizeRange, normalizeSelectionForMerges, SelectionManager, type DirtyTracker, type FreeTable } from '@lingyi-doc/core-sheet';
import type { CellCoord, CellRange, CellValue } from '@lingyi-doc/core-types';
