...
import type { DocCommentThread, WhiteboardViewport } from '@lingyi-doc/core';
import { getWhiteboardCommentPin } from '@lingyi-doc/core';
...
export const WbCommentPinOverlay: React.FC<WbCommentPinOverlayProps> = ({
  ...
  const resolvePin = useCallback((thread: DocCommentThread) => {
    ...
    return getWhiteboardCommentPin(thread.anchor);
  }, [draftPins]);
  ...
  }, [activeThreads, onPinMove, onSelect, readOnly]);
