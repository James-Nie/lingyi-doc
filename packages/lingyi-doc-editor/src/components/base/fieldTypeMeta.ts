...
export const FIELD_PALETTE_TYPES: Record<FieldTypeCategory, ColumnType[]> = {
  regular: ['text', 'select', 'multiSelect', 'user', 'date', 'datetime', 'attachment', 'number', 'boolean', 'link', 'formula'],
  business: ['autoNumber', 'phone', 'email', 'progress', 'currency', 'rating', 'percent'],
};
