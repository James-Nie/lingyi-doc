...
import type { MindNode, MindNoteSettings } from '@lingyi-doc/core';
import { findMindNode, getMindNodeFontSize, getMindNodeLineHeight } from '@lingyi-doc/core';
import { DOC_PAGE_BG } from '../doc/styles';
    ...
    <div style={{
      ...
      >
        <MindNoteControls
          ...
          canUndo={canUndo}
          canRedo={canRedo}
          onViewModeChange={mode => onSettingsChange({ viewMode: mode })}
        ...
        {isMap ? (
          ...
          <div style={{ flex: 1, minHeight: 0, overflow: 'auto', padding: '24px 0' }}>
            <div style={{
              ...
              <div
                ...
                onInput={e => {
                  if (readOnly) return;
                  onNodeTextChange(root.id, (e.target as HTMLElement).textContent ?? '');
                }}
                style={{
