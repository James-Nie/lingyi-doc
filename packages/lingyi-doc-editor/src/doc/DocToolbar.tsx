...
import type { ToolbarState, ParagraphStyle, BlockAlign } from '@lingyi-doc/core';
import { FONT_SIZES } from '@lingyi-doc/core';
import {
  toolbarDivider,
  DOC_COLORS,
...
import { ToolbarTooltip, modShortcut, redoShortcut, headingShortcut } from '../components/Toolbar/Tooltip';
...
import {
  ...
  IconOutline, IconFullscreen, IconHighlight, IconTextColor, IconChevronDown, IconBtnWrap,
