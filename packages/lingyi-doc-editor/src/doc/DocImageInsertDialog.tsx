    ...
    >
      <Upload.Dragger {...uploadProps} disabled={loading} style={{ padding: '16px 0' }}>
        <p style={{ marginBottom: 8 }}>
          <InboxOutlined style={{ fontSize: 40, color: DOC_COLORS.primary }} />
        </p>
        <p style={{ fontSize: 15, color: DOC_COLORS.text, margin: '0 0 4px' }}>
          点击或拖拽图片到此处
        </p>
        <p style={{ fontSize: 13, color: DOC_COLORS.muted, margin: 0 }}>
