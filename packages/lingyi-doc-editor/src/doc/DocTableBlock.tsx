...
import type { TableBlock, TableCell, BlockAlign, TableCellStyle, TableCellVerticalAlign, PendingCaret } from '@lingyi-doc/core';
import {
  addTableColumn,
  addTableRow,
  ensureTableSizes,
  ...
  setCaretOffset,
  resolveCaretOffset,
  DOC_TABLE_MIN_COL_WIDTH,
  DOC_TABLE_MIN_ROW_HEIGHT,
  DOC_TABLE_GUTTER_WIDTH,
  DOC_TABLE_INSERT_BTN_SIZE,
