import type { CellValue, ColumnDef, RecordChangeEntry, RecordRow } from '../types/index';
...
export function appendRecordCreateHistory(record: RecordRow, operator = 'local'): void {
