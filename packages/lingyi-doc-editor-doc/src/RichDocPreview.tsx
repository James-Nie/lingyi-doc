...
import type { DocBlock, ListBlock, ListItem, TableBlock, TableCell, WhiteboardBlock } from '@lingyi-doc/core-doc';
import { ensureTableSizes, getBlockIndentStyle, getTableCellTypography, isTextBlock, marksToHtml, orderedListMarker, getBulletMarkerForLevel } from '@lingyi-doc/core-doc';
  ...
  if (block.type === 'whiteboard') {
    ...
    return (
      <div style={{
        ...
        {(() => {
          const Preview = getEditorEmbed('whiteboard-preview');
          return Preview
            ? <Preview elements={wb.whiteboardData.elements} height={320} />
            : <div style={{ padding: 24, color: '#86909C', fontSize: 13 }}>画板预览未加载</div>;
        })()}
      </div>
    );
  }
