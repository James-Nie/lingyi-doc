import type { DocBlock, TableCell } from '@lingyi-doc/core-doc';
import { createEmptyTableCell, fitTableColumnWidths, genBlockId, DOC_TABLE_DEFAULT_ROW_HEIGHT } from '@lingyi-doc/core-doc';
import {
  elementsByLocalName,
  firstByLocalName,
  readZipText,
