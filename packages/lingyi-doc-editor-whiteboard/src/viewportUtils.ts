import type { WhiteboardElement, WhiteboardPoint, WhiteboardViewport } from '@lingyi-doc/core-whiteboard';
import { getSeqFullBounds, isSeqLifelineKind } from '@lingyi-doc/core-whiteboard';
