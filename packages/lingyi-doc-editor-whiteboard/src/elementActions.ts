import type { ConnectorElement, ShapeElement, WhiteboardElement, WhiteboardPoint } from '@lingyi-doc/core-whiteboard';
import { connectorEndArrow, connectorStartArrow } from '@lingyi-doc/core-whiteboard';
...
const TRANSFORMABLE = new Set(['shape', 'text', 'sticky', 'image', 'section', 'table']);
